...
def main() -> None:
    ...
    print("Psi values")
    print("----------")
    print(f"Psi_e   = {format_fraction(psi.psi_e):>7} = {fraction_to_decimal(psi.psi_e):.2f}")
    print(f"Psi_p   = {format_fraction(psi.psi_p):>7} = {fraction_to_decimal(psi.psi_p):.2f}")
    print(f"Psi_n   = {format_fraction(psi.psi_n):>7} = {fraction_to_decimal(psi.psi_n):.2f}")
    print(f"Psi_mu  = {format_fraction(psi.psi_mu):>7} = {fraction_to_decimal(psi.psi_mu):.2f}")
    print(f"Psi_tau = {format_fraction(psi.psi_tau):>7} = {fraction_to_decimal(psi.psi_tau):.2f}")
